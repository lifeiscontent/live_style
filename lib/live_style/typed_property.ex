defmodule LiveStyle.TypedProperty do
  @moduledoc """
  ...
  ## Examples
      ...
      alias LiveStyle.{TypedProperty, Units}

      vars [
        rotation: TypedProperty.angle(Units.deg(0)),
        progress: TypedProperty.percentage(Units.percent(0)),
        scale: TypedProperty.number(1)
      ]
  ...
  ## Examples
      ...
      TypedProperty.length(Units.px(0)) |> TypedProperty.no_inherit()
  """
  ...
  ## Examples
      ...
      TypedProperty.custom("<length> | auto", "auto")
  """
