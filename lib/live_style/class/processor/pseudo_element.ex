defmodule LiveStyle.Class.Processor.PseudoElement do
  @moduledoc """
  ...
  ## Example
      ...
      iex> transform([{"::after", [content: "''", display: "block"]}])
      [
  ...
  # The selector (e.g., "::before") is passed to Builder which handles CSS generation
  defp build_class_entry(css_prop, value, selector) do
    entry = Builder.create_entry(css_prop, value, selector: selector)
    {"#{css_prop}#{selector}", entry}
  end
end
