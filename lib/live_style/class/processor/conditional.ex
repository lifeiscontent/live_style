defmodule LiveStyle.Class.Processor.Conditional do
  @moduledoc """
  ...
  ## Example
      ...
      iex> transform([{:color, [default: "red", ":hover": "blue"]}])
      [
        {"color", %{
          classes: [
  ...
  defp build_class_entry(css_prop, selector, css_value) do
    ...
    entry = Builder.create_entry(css_prop, css_value, selector: selector_suffix, at_rule: at_rule)
    {selector, entry}
  end
end
