defmodule LiveStyle.PropertyType.Numeric do
  @moduledoc false

  @spec integer(integer() | String.t() | map()) :: LiveStyle.PropertyType.typed_value()
  ...
  @spec number(number() | String.t() | map()) :: LiveStyle.PropertyType.typed_value()
