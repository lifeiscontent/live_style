defmodule LiveStyle.Compiler.Class.Processor.Simple do
  @moduledoc """
  ...
  defp process_simple_value(css_prop, value) do
    {css_prop, Builder.build(css_prop, value)}
  end
  ...
  alias LiveStyle.Compiler.Class.Fallback

  defp process_array_fallbacks(css_prop, values) do
    Fallback.process_array(css_prop, values)
  end

  defp process_fallback(css_prop, values) do
    Fallback.process_fallback(css_prop, values)
  end
