defmodule LiveStyle.PropertyMetadata do
  @moduledoc """
  Compile-time CSS property metadata loading for LiveStyle.

  This module loads and caches CSS property data from text files at compile time,
