defmodule LiveStyle.PropertyMetadata.Parser do
  @moduledoc """
  Parses data files for LiveStyle CSS property metadata.
  ...
  # __DIR__ is lib/live_style/property_metadata, so we go up three levels to reach the project root
